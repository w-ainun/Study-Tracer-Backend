...
class KuesionerRepository implements KuesionerRepositoryInterface
{
    ...
    {
        // Cek apakah ada section_ques dengan judul yang sama, atau buat baru
        ...
        $pertanyaan = Pertanyaan::create([
            ...
            'isi_pertanyaan' => $data['pertanyaan'],
        ]);
    ...
    public function updatePertanyaan(int $pertanyaanId, array $data)
    {
        ...
        $updateData = ['isi_pertanyaan' => $data['pertanyaan']];
    ...
    {
        $kuesioner = Kuesioner::with(['sectionQues.pertanyaan.opsiJawaban'])->findOrFail($kuesionerId);
